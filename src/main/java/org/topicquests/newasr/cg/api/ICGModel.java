...
public interface ICGModel {
	...
	IResult getConcept(String conceptLocator);
	
	IResult removeConcept(String conceptLocator);
	
	//TODO what is this?
	IResult listConceptsForProxy(String proxyLocator);
	...
	IResult getGraph(String graphLocator);
	...
	IResult getRelation(String relationLocator);
